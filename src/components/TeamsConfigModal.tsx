...
import { X, Video, CheckCircle2, AlertCircle, ExternalLink } from 'lucide-react';
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full">
        ...
        <div className="flex items-center justify-between p-6 border-b">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900">Configure Microsoft Teams</h2>
              <p className="text-sm text-gray-600">Connect your Microsoft Teams workspace</p>
            </div>
          </div>
          <button
            onClick={onClose}
            ...
            <div className="space-y-6">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div className="flex gap-3">
                  ...
                  <div className="text-sm text-blue-800">
                    ...
                    <p>
                      To use Microsoft Teams integration, you need to authorize ChatAI to access your Teams workspace.
                      This is done securely through Microsoft's OAuth 2.0 system.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="grid gap-3">
                  <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Post messages to channels and chat with team members
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Access messages from channels and chats
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Upload and download files in Teams
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="border-t pt-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1 ml-4 list-disc">
                  <li>Read and send messages in Teams</li>
                  <li>Access team and channel information</li>
                  <li>Read and write files in Teams</li>
          ...
          {step === 'success' && (
            <div className="text-center py-8">
              ...
              <p className="text-gray-600 mb-6">
                You can now use Microsoft Teams in your conversations.
              </p>
